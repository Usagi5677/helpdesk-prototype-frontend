  ...
  return (
    <div className={classes["knowledgebase-container"]}>
      <div className={classes["knowledgebase-content-wrapper"]}>
        ...
        <div className={classes["content"]} dangerouslySetInnerHTML={{ __html: clean }}></div>
      </div>
      <div className={classes["knowledgebase-information-wrapper"]}>
        ...
        <div>
          ...
          <div className={classes["heading__row"]}>
            ...
            <div className={classes["heading__row__right"]}>{moment(knowledgebaseData?.createdAt).format("DD MMMM YYYY HH:mm")}</div>
          </div>
          <div className={classes["heading__row"]}>
            <div className={classes["heading__row__left"]}>Created By:</div>
            <div className={classes["heading__row__right"]}>{knowledgebaseData?.createdBy.fullName}</div>
          </div>
        </div>
      </div>
    </div>
